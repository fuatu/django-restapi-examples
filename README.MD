...
- sample curl code for getting details with token
```zsh
$ curl --location --request GET 'http://localhost:8000/seventhapp/employees/' \
--header 'Authorization: Token sampletokenstring' 
```
